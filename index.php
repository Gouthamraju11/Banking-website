...
<html lang="en">
<head>
   <title>Grow BANK®-Honours Your Trust</title>
   <meta charset="utf-8">
...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
  <div class="container-fluid">
    <a class="navbar-brand" href="#">Grow BANK®-Honours Your Trust</a>
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav ml-auto">
        ...
        <li class="nav-item">
          <a class="nav-link active" aria-current="page" href="contactme.php">Contact Us</a>
        </li>
...
<div  class="col-lg-6 col-md-6 col-12">
      ...
      <div  class="col-lg-6 col-md-6 col-12">
      <h1>Grow BANK®-Honours Your Trust</h1>
      <p1> Welcome to Grow BANK®. It is one of leading private banks. Grow BANK® offers a diverse range of financial products and banking services to customers through a growing branch and ATM network and digital channels such as Netbanking, Phonebanking and MobileBanking.
...
<footer class="text-center mt-2 py-5">
        <p>&copy 2021  <b>K S Goutham Raju</b> </br>Chairman</p>
      </footer>
